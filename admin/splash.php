...
function splash()
{
    $utm = '?utm_source=about&utm_medium=about&utm_campaign='.WP_FAIL2BAN_ADDON_GRAVITY_FORMS_VER;

    $logo_box = [
        'title' => 'WP fail2ban add-on<br>for Gravity Forms',
        'logo'  => plugins_url('assets/icon.png', WP_FAIL2BAN_ADDON_GRAVITY_FORMS_FILE),
        'links' => [
            'Blog'      => "https://addons.wp-fail2ban.com/blog/{$utm}&addon=gravity-forms",
            'Guide'     => "https://life-with.wp-fail2ban.com/add-ons/gravity-forms/{$utm}",
            'Support'   => "https://forums.invis.net/c/wp-fail2ban-gravity-forms/support/{$utm}"
        ]
    ];
    ?>
<div class="wrap" id="wp-fail2ban">
  <div id="poststuff">
    <div id="post-body" class="metabox-holder columns-2">
      <div id="post-body-content">
        <div class="meta-box-sortables ui-sortable">
          <div class="postbox">
            <h2>Version <?=WP_FAIL2BAN_ADDON_GRAVITY_FORMS_VER?></h2>
            <div class="inside">
              <section>
    ...
    if (function_exists('org\lecklider\charles\wordpress\wp_fail2ban\readme')) {
        readme(WP_FAIL2BAN_ADDON_GRAVITY_FORMS_VER_SHORT, WP_FAIL2BAN_ADDON_GRAVITY_FORMS_DIR.'/readme.txt');
    } else {
